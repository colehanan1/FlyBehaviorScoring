...
Example usage:
    ...
    flybehavior-response train --data-csv data.csv --labels-csv labels.csv \\
        --classification-mode multiclass --model mlp --artifacts-dir multiclass_artifacts

    # Then analyze thresholds
    python threshold_slider.py --predictions-csv multiclass_artifacts/latest/predictions_mlp_test.csv \\
