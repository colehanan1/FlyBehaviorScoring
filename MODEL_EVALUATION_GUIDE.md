...
```bash
./evaluate_model_workflow.sh artifacts/all_weighted/2025-11-13T22-18-43Z random_forest
```
...
flybehavior-response train \
  ...
  --rf-n-estimators 150 \
  --artifacts-dir artifacts/my_experiment
```

This creates a directory like: `artifacts/my_experiment/2025-11-13T22-18-43Z/`
...
cat artifacts/my_experiment/*/predictions_random_forest_train.csv

# Count errors in training set
grep "False" artifacts/my_experiment/*/predictions_random_forest_train.csv | wc -l
```
...
python analyze_model_errors.py \
  --run-dir artifacts/my_experiment/2025-11-13T22-18-43Z \
  --model random_forest \
  --output-dir artifacts/my_experiment/2025-11-13T22-18-43Z/error_analysis
```
...
cat artifacts/my_experiment/*/error_analysis/errors_random_forest_test_false_positives.csv

# See the false negatives (model said "No" but true answer was "Yes")
cat artifacts/my_experiment/*/error_analysis/errors_random_forest_test_false_negatives.csv
```
...
xdg-open artifacts/my_experiment/*/error_analysis/confusion_matrices_random_forest.png
xdg-open artifacts/my_experiment/*/error_analysis/probability_distributions_random_forest.png
...
flybehavior-response predict \
  --data-csv /home/ramanlab/Documents/cole/Data/Opto/Combined/all_envelope_rows_wide.csv \
  --model-path artifacts/my_experiment/*/model_random_forest.joblib \
