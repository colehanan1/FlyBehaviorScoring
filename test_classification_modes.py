...
# Paths
data_path = Path("/home/ramanlab/Documents/cole/Data/Opto/Combined/all_envelope_rows_wide.csv")
labels_path = Path("/home/ramanlab/Documents/cole/model/FlyBehaviorPER/scoring_results_opto_new_MINIMAL.csv")
...
try:
    results_binary = train_models(
        ...
        artifacts_dir=Path("test_classification_modes/binary"),
        seed=67,
        verbose=False,
        dry_run=False,
...
try:
    results_multiclass = train_models(
        ...
        models=["mlp"],
        cv=0,
        artifacts_dir=Path("test_classification_modes/multiclass"),
        seed=67,
        verbose=False,
        dry_run=False,
    ...
    pred_path = Path("test_classification_modes/multiclass")
...
try:
    results_threshold2 = train_models(
        ...
        models=["mlp"],
        cv=0,
        artifacts_dir=Path("test_classification_modes/threshold2"),
        seed=67,
        verbose=False,
        dry_run=False,
