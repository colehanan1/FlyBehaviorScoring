...
This test replicates the configuration from:
/home/ramanlab/Documents/cole/VSCode/FlyBehaviorScoring/artifacts/real_data_all_models_seed67/2025-12-07T19-43-08Z/config.json
"""
...
for mode_key, mode_name in classification_modes.items():
    ...
    artifacts_dir = f"comprehensive_test/{mode_key}"
