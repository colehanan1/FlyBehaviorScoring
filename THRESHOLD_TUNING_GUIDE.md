...
python find_optimal_threshold.py \
  artifacts/rf_corrected_labels_v1/2025-11-14T18-58-28Z/predictions_random_forest_test.csv \
  recall
```
...
flybehavior-response predict \
  --model-path artifacts/rf_corrected_labels_v1/2025-11-14T18-58-28Z/model_random_forest.joblib \
