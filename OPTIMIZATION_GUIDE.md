...
flybehavior-response train \
  ...
  --artifacts-dir artifacts/experiment_1
```
...
flybehavior-response train \
  ...
  --n-pcs 6 \
  --logreg-class-weights "0:1.0,1:2.0" \
  --artifacts-dir artifacts/logreg_cw_2
...
flybehavior-response train \
  ...
  --n-pcs 6 \
  --logreg-class-weights "0:1.0,1:3.0" \
  --artifacts-dir artifacts/logreg_cw_3
```
...
flybehavior-response train \
  ...
  --rf-class-weights balanced \
  --rf-n-estimators 150 \
  --artifacts-dir artifacts/rf_balanced
...
flybehavior-response train \
  ...
  --rf-class-weights "0:1.0,1:3.0" \
  --rf-n-estimators 150 \
  --artifacts-dir artifacts/rf_cw_3
```

### Step 3: Compare Results

After training, check the metrics in `artifacts/*/metrics.json`:
...
cat artifacts/logreg_cw_2/*/metrics.json
cat artifacts/rf_balanced/*/metrics.json
```
...
flybehavior-response train \
  ...
  --model mlp \
  --n-pcs 6 \
  --best-params-json optuna_results/best_params.json  # If you have tuned params
```
...
for weight in "0:1.0,1:2.0" "0:1.0,1:3.0" "balanced"; do
  flybehavior-response train \
    ...
    --artifacts-dir "artifacts/logreg_weight_${weight//[^0-9]/}"
done
...
flybehavior-response train \
  ...
  --logreg-class-weights "0:1.0,1:2.0" \
  --rf-class-weights "0:1.0,1:2.0" \
  --artifacts-dir artifacts/all_models_cw2
```
