...
def find_optimal_threshold(predictions_csv: str, strategy: str = "f1"):
    ...
    if best['threshold'] < 0.5:
        ...
        print(f"  --model-path artifacts/rf_corrected_labels_v1/2025-11-14T18-58-28Z/model_random_forest.joblib \\")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("    artifacts/rf_corrected_labels_v1/2025-11-14T18-58-28Z/predictions_random_forest_test.csv \\")
        print("    recall")
        sys.exit(1)
