...
flybehavior-response predict \
    --model-path outputs/artifacts/2025-11-13T20-14-45Z/model_logreg.joblib \
...
Extend existing [scripts/tune/optuna_mlp_tuning.py](scripts/tune/optuna_mlp_tuning.py) to cover LogReg and RF:
...
# Load predictions
current_preds = pd.read_csv("outputs/artifacts/latest/predictions_logreg_test.csv")
...
7. Extend `scripts/tune/optuna_mlp_tuning.py` to cover LogReg/RF
...
- Best Model: `outputs/artifacts/2025-11-13T20-14-45Z/model_logreg.joblib`
- Config: `outputs/artifacts/2025-11-13T20-14-45Z/config.json`
- Predictions: `outputs/artifacts/2025-11-13T20-14-45Z/predictions_logreg_test.csv`
- Metrics: `outputs/artifacts/2025-11-13T20-14-45Z/metrics.json`
