...
```bash
python scripts/analysis/analyze_errors.py outputs/artifacts/rf_tuned/2025-11-14T01-47-01Z/predictions_random_forest_test.csv
```
...
pipeline = joblib.load("outputs/artifacts/rf_tuned/2025-11-14T01-47-01Z/model_random_forest.joblib")
